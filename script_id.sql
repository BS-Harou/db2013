...
CREATE TABLE IF NOT EXISTS `mydb`.`Skupiny_Clenove` (
  ...
  INDEX `fk_Skupiny_has_Clenove_Clenove1_idx` (`id_clenove` ASC),
  INDEX `fk_Skupiny_has_Clenove_Skupiny_idx` (`id_Skupiny` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Nastroje_Clenove` (
  ...
  INDEX `fk_Nastroje_has_Clenove_Clenove1_idx` (`id_Clenove` ASC),
  INDEX `fk_Nastroje_has_Clenove_Nastroje1_idx` (`id_Nastroje` ASC),
  CONSTRAINT `fk_Nastroje_has_Clenove_Nastroje1`
    FOREIGN KEY (`id_Nastroje`)
...
CREATE TABLE IF NOT EXISTS `mydb`.`Alba` (
  ...
  `id_Skupiny` INT NOT NULL,
  `id_Vydavatel` INT NULL,
  PRIMARY KEY (`id_Alba`),
  INDEX `fk_Alba_Skupiny1_idx` (`id_Skupiny` ASC),
  INDEX `fk_Alba_Vydavatele1_idx` (`id_Vydavatel` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Skladby` (
  ...
  INDEX `fk_Skladby_Alba1_idx` (`id_Alba` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Skladby_Clenove` (
  ...
  INDEX `fk_Skladby_has_Clenove_Clenove1_idx` (`id_Clenove` ASC),
  INDEX `fk_Skladby_has_Clenove_Skladby1_idx` (`id_Skladby` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Oblibene_Skupiny` (
  ...
  INDEX `fk_Uzivatele_has_Skupiny_Skupiny1_idx` (`id_Skupiny` ASC),
  INDEX `fk_Uzivatele_has_Skupiny_Uzivatele1_idx` (`id_Uzivatele` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Oblibene_Clenove` (
  ...
  INDEX `fk_Uzivatele_has_Clenove_Clenove1_idx` (`id_Clenove` ASC),
  INDEX `fk_Uzivatele_has_Clenove_Uzivatele1_idx` (`id_Uzivatele` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Uzivatele_has_Role` (
  ...
  INDEX `fk_Uzivatele_has_Role_Role1_idx` (`id_Role` ASC),
  INDEX `fk_Uzivatele_has_Role_Uzivatele1_idx` (`id_Uzivatele` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Zadosti` (
  ...
  INDEX `fk_Zadosti_Uzivatele1_idx` (`id_Uzivatele` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Hodnoceni_Skupin` (
  ...
  INDEX `fk_Skupiny_has_Uzivatele_Uzivatele1_idx` (`id_Uzivatele` ASC),
  INDEX `fk_Skupiny_has_Uzivatele_Skupiny1_idx` (`id_Skupiny` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Hodnoceni_skladeb` (
  ...
  INDEX `fk_Skladby_has_Uzivatele_Uzivatele1_idx` (`id_Uzivatele` ASC),
  INDEX `fk_Skladby_has_Uzivatele_Skladby1_idx` (`id_Skladby` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Hodnoceni_clenu` (
  ...
  INDEX `fk_Clenove_has_Uzivatele_Uzivatele1_idx` (`id_Uzivatele` ASC),
  INDEX `fk_Clenove_has_Uzivatele_Clenove1_idx` (`id_Clenove` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Hodnoceni_alb` (
  ...
  INDEX `fk_Alba_has_Uzivatele_Uzivatele1_idx` (`id_Uzivatele` ASC),
  INDEX `fk_Alba_has_Uzivatele_Alba1_idx` (`id_Alba` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Oblibene_Alba` (
  ...
  `popis` VARCHAR(100) NULL,
  PRIMARY KEY (`id_Alba`, `id_Uzivatele`),
  INDEX `fk_Alba_has_Uzivatele_Uzivatele2_idx` (`id_Uzivatele` ASC),
  INDEX `fk_Alba_has_Uzivatele_Alba2_idx` (`id_Alba` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Oblibene_Skladby` (
  ...
  INDEX `fk_Uzivatele_has_Skladby_Skladby1_idx` (`id_Skladby` ASC),
  INDEX `fk_Uzivatele_has_Skladby_Uzivatele1_idx` (`id_Uzivatele` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Fotografie_spojova` (
  ...
  INDEX `fk_Fotografie_spojova_Skladby1_idx` (`id_entita` ASC),
  CONSTRAINT `fk_Fotografie_spojova_Fotografie1`
    FOREIGN KEY (`id_Fotografie`)
    REFERENCES `mydb`.`Fotografie` (`id_Fotografie`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Fotografie_spojova_Skladby1`
    FOREIGN KEY (`id_entita`)
    REFERENCES `mydb`.`Skladby` (`id_Skladby`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Fotografie_spojova_Vydavatele1`
    FOREIGN KEY (`id_entita`)
    REFERENCES `mydb`.`Vydavatele` (`id_Vydavatel`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Fotografie_spojova_Skupiny1`
    FOREIGN KEY (`id_entita`)
    REFERENCES `mydb`.`Skupiny` (`id_Skupiny`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`Fotografie_spojova_Clenove` (
  ...
  INDEX `fk_Fotografie_spojova_has_Clenove_Clenove1_idx` (`id_Clenove` ASC),
  INDEX `fk_Fotografie_spojova_Clenove_Fotografie_spojova1_idx` (`id_Fotografie` ASC, `typ` ASC, `id_entita` ASC),
  CONSTRAINT `fk_Fotografie_spojova_has_Clenove_Clenove1`
    FOREIGN KEY (`id_Clenove`)
    REFERENCES `mydb`.`Clenove` (`id_Clenove`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Fotografie_spojova_Clenove_Fotografie_spojova1`
    FOREIGN KEY (`id_Fotografie` , `typ` , `id_entita`)
    REFERENCES `mydb`.`Fotografie_spojova` (`id_Fotografie` , `typ` , `id_entita`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
